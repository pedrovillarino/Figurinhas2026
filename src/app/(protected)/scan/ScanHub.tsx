  ...
  if (state === 'preview') {
    return (
      <div className="px-4 pt-6">
        ...
        {/* Pedro 2026-05-09: aviso de qualidade reforçado. A IA precisa ler
            código (verso) OU nome (frente) — sem isso, não acha. Nitidez é
            o fator nº 1. Verso (com número) tem assertividade muito maior. */}
      ...
      <div className="px-4 pt-6">
        ...
        {scanResult.matched.length === 0 ? (
          <div className="text-center text-gray-400 mt-8">
            ...
            {/* Pedro 2026-05-05: removido ad scan_no_results — UX ruim
                (reforço negativo após scan falho). */}
          </div>
        ) : (
          <>
