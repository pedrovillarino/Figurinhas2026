...
export default function TradesPaywall({ currentTier }: { currentTier: Tier }) {
  return (
    <div className="px-4 pt-6">
      <h1 className="text-xl font-bold mb-1 text-gray-900">Trocas</h1>
      <p className="text-xs text-gray-400 mb-8">Encontre colecionadores perto de você</p>
      ...
      <PaywallModal feature="trades" currentTier={currentTier} />
    </div>
  )
}
