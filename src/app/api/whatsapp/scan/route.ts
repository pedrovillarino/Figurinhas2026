...
- FWC-9 a FWC-19: SÉRIE HISTÓRICA "FIFA MUSEUM". Cada figurinha é uma FOTO COLORIDA (NÃO P&B/sépia) do time campeão posando em fileira (squad portrait). Embaixo tem uma FAIXA MARROM/VINHO ESCURO com: logo pequeno "FIFA MUSEUM" à ESQUERDA (texto branco + selo escuro) + NOME DO PAÍS em letras maiúsculas brancas grandes + ANO em branco na ponta direita. Bordas FOIL HOLOGRÁFICO PRATA com texto "Panini" repetido em padrão brilhante. Exemplos: "ARGENTINA 1986" (camisas listradas branco/azul-claro), "BRAZIL 1994" (camisas amarelas tradicionais), "URUGUAY 1950", "ITALY 2006", "GERMANY 2014", "ARGENTINA 2022". player_name = "{Campeão} {Ano}". NÃO é nome de jogador. ⚠️ IMPORTANTE: NÃO é P&B/sépia — é foto COLORIDA do time.
