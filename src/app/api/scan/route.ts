...
- FWC-9 to FWC-19: HISTORICAL SERIES "FIFA MUSEUM". Each sticker is a COLOR PHOTO (not B&W/sepia) of a former World Cup champion team posing in a row (squad portrait). Bottom of the sticker has a DARK MAROON/WINE-COLORED BAR containing: small "FIFA MUSEUM" logo on the LEFT (white text + dark FIFA seal) + COUNTRY NAME in big white capital letters + YEAR in white at the right edge. Borders are SILVER FOIL HOLOGRAPHIC with "Panini" text repeated in shimmer. Examples seen: "ARGENTINA 1986" (white-and-light-blue striped jerseys), "BRAZIL 1994" (yellow jerseys, tradicional Brasil kit). player_name = "{Champion} {Year}" format like "Uruguay 1950", "Brazil 1962", "Argentina 1986", "Italy 2006", "Germany 2014", "Argentina 2022", "Brazil 1994". NOT a player name. ⚠️ IMPORTANT: it's NOT B&W/sepia — it's a COLOR squad photo.
