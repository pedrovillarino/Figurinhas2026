...
- {COUNTRY}-1: federation BADGE/CREST. Read the LETTERS on the crest to identify the country. player_name = "Emblem". Common federation acronyms:
  ...
  - Detailed visual descriptions (canonical crest reference):
    ...
    - CZE-1 (FAČR Czechia/Czech Republic): LARGE WHITE CIRCLE in the center containing a DARK RED MEDIEVAL HERALDIC SHIELD (curved coat-of-arms shape). Inside the shield: SILVER/WHITE LION RAMPANT (standing upright on hind legs, facing left) with the UNIQUE CZECH FEATURE — TWO TAILS (not one — two distinct tails, unique in football emblems). The lion has a small GOLDEN CROWN on its head, claws extended, and a RED TONGUE sticking out. Above the shield, within the white circle, a thin horizontal strip with three Czech flag colors (white/red/blue). Sticker background: DARK RED/BURGUNDY (wine) with subtle diagonal stripes. Text "FIFA WORLD CUP 2026" at the top in WHITE letters. Yellow "PANINI" logo at bottom-right.
       ⚠️ DO NOT CONFUSE WITH:
         • SFA Scotland (also a lion rampant but with ONE tail + different shield colors/layout)
         • Other lion-bearing crests (FA England has 3 LIONS PASSANT/lying down, NOT standing with double tail)
       🎯 UNIQUE VISUAL: SILVER lion with TWO tails in a RED shield, inside a WHITE CIRCLE, on a BURGUNDY/DARK-RED background = CZE-1.
...
- FWC-1: "Taça Oficial (parte de cima)" — FOIL/HOLOGRAPHIC SILVER sticker showing the TOP HALF of the FIFA trophy (GOLD statuette: human figure holding the gold globe at top, plus the trophy's neck). Cropped UPPER half. Silver holographic background with repeated Panini pattern. NO colorful text on the front — just the gold statuette stands out against the foil.
- FWC-2: "Taça Oficial (parte de baixo)" — FOIL/HOLOGRAPHIC SILVER sticker showing the BOTTOM HALF of the FIFA trophy (GOLD cylindrical BASE + lower trophy body rising). Cropped LOWER half, visually complements FWC-1. Same silver holographic background. Text "FIFA WORLD CUP" may be engraved on the gold base.
- ⚠️ FWC-1 + FWC-2 together form the complete trophy — if a photo shows the WHOLE trophy vertically and is HOLOGRAPHIC silver, it might capture both stickers in one image (check for a divider or two stickers placed adjacent).
...
- FWC-4: "Troféu Oficial" — FOIL/HOLOGRAPHIC sticker with PRISMATIC SHIMMERY background (multicolor — green, blue, purple, red iridescent). Centered: stylized GREEN trophy/cup graphic (silhouette/symbol of the FIFA trophy in green color, NOT the gold detailed statuette of FWC-1/2). Text "FIFA" appears small at top-left. PANINI logo at bottom. ⚠️ NOT to confuse with: FWC-0 (We are Panini, has player kicking bicycle); FWC-1/2 (gold trophy halves, no foil); FWC-6/7/8 (gold trophy on solid color background with "CAN MEX USA" text). FWC-4 is the ONLY one with green stylized trophy on iridescent foil background.
...
- FWC-9 to FWC-19: HISTORICAL SERIES "FIFA MUSEUM". Each sticker is a PHOTO of a former World Cup champion team posing in a row (squad portrait). Bottom of the sticker has a DARK MAROON/WINE-COLORED BAR containing: small "FIFA MUSEUM" logo on the LEFT (white text + dark FIFA seal) + COUNTRY NAME in big white capital letters + YEAR in white at the right edge. Borders are SILVER FOIL HOLOGRAPHIC with "Panini" text repeated in shimmer.
  - OLD CHAMPIONS (FWC-9 Italy 1934, FWC-10 Brazil 1950, FWC-11 West Germany 1954) may have B&W or sepia photos (era of black-and-white film). Don't treat that as "wrong" — it's the actual historical record.
  - CHAMPIONS FROM 1962 ONWARDS (FWC-12 to FWC-19: Chile 1962, Germany 1974, Mexico 1986, USA 1994, Korea/Japan 2002, Germany 2006, Brazil 2014, Qatar 2022) are COLOR squad photos.
  - player_name = "{Champion} {Year}". NOT a player name.
  - Examples: "WEST GERMANY 1954" (B&W), "ARGENTINA 1986" (white-and-light-blue striped jerseys), "BRAZIL 1994" (yellow), "ITALY 2006", "GERMANY 2014", "ARGENTINA 2022".
